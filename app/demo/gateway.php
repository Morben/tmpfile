...
$callback_url = 'http://xjplus.xyz/demo/notify.php';
//支付成功后自动跳转url
$success_url = 'http://xjplus.xyz/demo/zzf_return.php?ddh='.$out_trade_no;
//支付失败或者超时后跳转url
$error_url = 'http://xjplus.xyz/';
...
<body>
<form action="http://xjplus.xyz/gateway/index/checkpoint.do" method="post" id="frmSubmit">
