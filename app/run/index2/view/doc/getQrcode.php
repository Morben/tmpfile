 ...
 <p class="caption">扫码支付API文档</p>
                ...
                <div class="col s12 m12 l12">
                  <table class="striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>content_type</td>
                        <td>请求过程中返回的网页类型，<b style="color:red;">text</b> (扫码支付 )或 <b style="color:red;">json</b>（H5支付）</td>
                        <td>json</td>
                      </tr>
                      <tr>
                        <td>thoroughfare</td>
                          <td>初始化支付通道，目前通道：<b style="color:red;">wechat_auto</b>（商户版微信）、<b style="color:red;">alipay_auto</b>（商户版支付宝）、<b style="color:red;">service_auto</b>（服务版微信/支付宝）</td>
                        <td>wechat_auto</td>
                      </tr>
                      <tr>
                        <td>type</td>
                      ...
                      <tr>
                        <td>keyId</td>
                        <td>设备KEY，在商户版列表里面Important参数下的DEVICE Key一项，如果该请求为轮训模式，则本参数无效，本参数为单通道模式</td>
                      ...
                      <tr>
                        <td>callback_url</td>
                          <td>异步通知地址，在支付完成时，本平台服务器系统会自动向该地址发起一条支付成功的回调请求, 对接方接收到回调后，<b>必须返回 <span style="color:red">success</span> ,否则默认为回调失败</b>,回调信息会补发3次。</td>
          ...
          <div class="section">
            ...
            <div id="input-fields">
              ...
              <div class="row">
                ...
                <div class="col s12 m12 l12">
                  <div class="row">
                    <form class="col s12" action="<?php echo URL_ROOT; ?>/gateway/index/checkpoint.do " method="post" target="_blank">
                      <div class="row">
        		...
        		<div  id="input-select">
                  ...
                  <div class="input-field col s12">
                         ...
                         <div class="input-field col s12">
                          <input type="text" class="validate" name="callback_url" value="<?php echo URL_ROOT; ?>/index/index/callback.do">
                          <label>callback_url</label>
                        </div>
                        
                        <div class="input-field col s12">
                          <input type="text" class="validate" name="success_url" value="<?php echo URL_ROOT; ?>/index/doc/getQrcode.do">
                          <label>success_url</label>
                        </div>
                        
                        <div class="input-field col s12">
                          <input type="text" class="validate" name="error_url" value="<?php echo URL_ROOT; ?>/index/doc/getQrcode.do">
      ...
      function reissue(id){
    	  swal({   title: "订单通知",   
              ...
              function(){
              //开始请求微信登录
            	   $.get("<?php echo url::s('index2/wechat/automaticReissue',"id=");?>" + id, function(result){
                  	 if(result.code == '200'){
      ...
      function trade_no(obj){
          location.href = "<?php echo url::s('index2/wechat/automaticOrder',"sorting=trade_no&code=");?>" + $(obj).val();
          }

      function wechat(){
          var wechat = $('#wechat').val();
          console.log(wechat);
          location.href = "<?php echo url::s('index2/wechat/automaticOrder',"sorting=wechat&code=");?>" + wechat;
