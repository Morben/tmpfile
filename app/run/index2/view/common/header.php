    ...
    <div id="main">
        ...
        <div class="wrapper">
            ...
            <aside id="left-sidebar-nav">
                ...
                <li class="bold active"><a href="<?php echo url::s('index2/panel/home');?>" class="waves-effect waves-cyan"><i class="mdi-action-dashboard"></i> 仪表盘</a>
                </li>
  <?php if ((new model())->load("user", "group")->check('alipay_auto')){?>
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-action-account-balance-wallet"></i> 支付宝红包模式</a>
                            <div class="collapsible-body">
                                <ul>
                                   
                                   <li><a href="<?php echo url::s('index2/alipay/automatic');?>">通道</a></li>
                                  <li><a href="<?php echo url::s('index2/alipay/automaticOrder');?>">支付订单</a></li>
                                  <li><a href="<?php echo url::s('index2/alipay/statisticOrder');?>">订单统计</a></li>
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-device-now-widgets"></i> 服务版</a>
                            <div class="collapsible-body">
                                <ul>
                                    <li><a href="<?php echo url::s('index2/service/order');?>">我的订单</a></li>
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-action-add-shopping-cart"></i> 商城</a>
                            <div class="collapsible-body">
                                <ul>
                                    <li><a href="<?php echo url::s('index2/shop/index');?>">商品列表</a></li>
                                    <li><a href="<?php echo url::s('index2/shop/order');?>">订单记录</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
               ...
               <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-action-account-balance-wallet"></i> 个人中心</a>
                            <div class="collapsible-body">
                                <ul>
                                   <li><a href="<?php echo url::s('index2/member/withdraw');?>">我的提现</a></li>
                                </ul>
                            </div>
                 		 </li>
                 	</ul>
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-av-my-library-books"></i> 接口文档</a>
                            <div class="collapsible-body">
                                <ul>
                                   <li><a href="<?php echo url::s('index2/doc/video');?>">视频教程</a></li>
                                   <li><a href="<?php echo url::s('index2/doc/getQrcode');?>">扫码支付</a></li>
                                   <li><a href="<?php echo url::s('index2/doc/sign');?>">签名算法</a></li>
                                   <li><a href="<?php echo url::s('index2/doc/getOrder');?>">订单信息</a></li>
                                   <li><a href="<?php echo url::s('index2/doc/orderStatus');?>">订单状态</a></li>
                                   <li><a href="<?php echo url::s('index2/doc/callback');?>">异步通知</a></li>
                                </ul>
                            </div>
                 		 </li>
                 	</ul>
			...
			function uploadPic(){
			    ...
			    $.ajax({
			        url:"<?php echo url::s('index2/member/avatarUpload');?>",
			        type:"post",
			        // Form数据
			        data: fd,
			        cache: false,
			            	...
			            	swal("操作提示", data.msg, "error");
                        	  ...
                        	  function edit(){
                        		  layer.open({
                        			  ...
                        			  shade: 0.8,
                        			  area: ['500px', '550px'],
                        			  content: '<?php echo url::s('index2/member/edit');?>' //iframe的url
                        			}); 
                        	  }
                        	  ...
                        	  function pay(){
                        		  layer.open({
                        			  ...
                        			  shade: 0.8,
                        			  area: ['500px', '340px'],
                        			  content: '<?php echo url::s('index2/member/pay');?>' //iframe的url
                        			});
                            	  }
                            </script>