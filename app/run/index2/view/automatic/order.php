      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">网商银行订单</h5>
                <ol class="breadcrumbs">
                    <li><a href="<?php echo url::s('index2/panel/home');?>">仪表盘</a></li>
                    <li><a href="#">订单列表</a></li> 
                  <font size="5" color="red">手动回调的无网商订单号</font>
                </ol>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="section">
            ...
            <p class="caption">
            <a href="<?php echo url::s("index/alipay/automatic");?>" style="font-size: 14px;" class="btn waves-effect waves-light  cyan darken-2"><i class="mdi-editor-border-all left" style="width: 10px;"></i>银行列表</a>
              ...
              <div class="row">
                ...
                <div class="col s12 m12 l12">
                  ...
                  <div class="input-field col s6" style="font-weight:normal;">
                    ...
                    <label>选择通道来查看<?php if ($_SESSION['ALIPAY']['ORDER']['WHERE'] == ''){?>(<a href="#" onclick="alipay();">开始查询</a>)<?php }else{?>(<a href="<?php echo url::s('index2/alipay/automaticOrder',"sorting=alipay&locking=closed");?>">取消锁定</a>)<?php }?></label>
                  </div>
                    ...
                    <?php foreach ($result['result'] as $ru){?>
                      <tr>
                        <td>网商卡ID：<a href='<?php echo url::s("index/alipay/automatic");?>'><?php echo $ru['alipay_id'];?></a> / 订单ID：<?php echo $ru['id'];?> ( <a target="_blank" href="<?php echo url::s('gateway/pay/automaticAlipay',"id={$ru['id']}");?>">支付链接</a> )
                        ...
                        <br>网商订单：<span style="color:red;"><?php echo htmlspecialchars($ru['bankorderid']);?></span>
                        </td>
...
//http://qakmak.com/index/alipay/automaticReissue.do?id=11160
      function reissue(id){
    	  swal({   title: "订单通知",   
