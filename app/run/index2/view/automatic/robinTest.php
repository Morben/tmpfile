...
<form action="<?php echo url::s('gateway/index/checkpoint');?>" method="post" id="frmSubmit">
	...
	<input type="hidden" name="success_url" value="<?php echo url::s('index2/alipay/automatic');?>" />
	<input type="hidden" name="error_url" value="<?php echo url::s('index2/alipay/automatic');?>" />
