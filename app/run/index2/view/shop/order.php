    ...
    <!-- START CONTENT -->
      ...
      function close_pay(id){
    	  swal({
            ...
            function(){
               $.get("<?php echo url::s('index2/shop/closeBuy',"id=");?>" + id, function(result){
              	 if(result.code == '200'){
      ...
      function applyRefund(id){
		  swal({
			  ...
			  $.ajax({
		          type: "POST",
		          dataType: "json",
		          url: "<?php echo url::s('index2/shop/applyRefund');?>",
		          data: dataTemp,
      ...
      function cancelRefund(id){
    	  swal({
            ...
            function(){
               $.get("<?php echo url::s('index2/shop/cancelRefund',"id=");?>" + id, function(result){
              	 if(result.code == '200'){
    	            	swal("交易提醒", result.msg, "success");
      ...
      function receipt(id){
    	  swal({
            ...
            function(){
               $.get("<?php echo url::s('index2/shop/receipt',"id=");?>" + id, function(result){
              	 if(result.code == '200'){
    	            	swal("交易提醒", result.msg, "success");
    	              	setTimeout(function(){location.href = '';},1000);
    	              }else{
      ...
      function order_query(id,title){ 
		  layer.open({
			  ...
			  shade: 0.8,
			  area: ['500px', '760px'],
			  content: '<?php echo url::s('index2/shop/logistics','id=');?>' + id
			}); 
	  	}

      function express(id,title){ 
    	  $.get("<?php echo url::s('index2/shop/express',"id=");?>" + id, function(result){
		  		if(result.code == '200'){
		  			layer.open({
				  		type: 2,
				  title: title,
