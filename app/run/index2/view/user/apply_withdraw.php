    ...
    <!-- START CONTENT -->
                ...
                <div class="col s12 m12 l12" style="margin-top: 8px;">
                  <div class="row">
                    <form class="col s12" id="from">
                      ...
                      <div class="row">
                         <div class="input-field col s3">
                          <input placeholder="6位短信验证码" id="code" name="code" type="text" class="validate" value="">
                          <label for="code">短信验证码</label>
                        </div>
                        <div class="input-field col s4" style="margin-top: 20px;">
                         <button type="button" class="btn waves-effect waves-light blue" onclick="getCode(this);">获取验证码</button>
                        </div>
                      </div>
      ...
      function apply(){
			$.ajax({
		          type: "POST",
		          dataType: "json",
		          url: "<?php echo url::s('index2/member/applyWithdrawResult');?>",
		          data: $('#from').serialize(),
	  ...
	  $.get("<?php echo url::s('index2/member/applyCode');?>", function(result){
	       	 if(result.code == '200'){
