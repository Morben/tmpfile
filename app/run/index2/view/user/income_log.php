    ...
    <script type="text/javascript" src="<?php echo URL_ROOT;?>/static/js/laydate/laydate.js"></script>
      ...
      <script type="text/javascript">
          ...
          function exportData () {
              ...
              if (code) {
                  location.href = "<?php echo url::s('index2/member/export', "sorting=alipay&code=");?>" + code+ '&start_time='+start_time + '&end_time=' + end_time;
              }else {
                  location.href = "<?php echo url::s('index2/member/export', "sorting=alipay&start_time=");?>" + start_time + '&end_time=' + end_time;
              }
          }
