                            ...
                            <div class="col s12 m6 l3">
                                <div class="card">
                                    <div class="card-content pink lighten-1 white-text">
                                        <p class="card-stats-title"><i class="mdi-maps-local-florist"></i> 网商银行</p>
                            ...
                            <div class="col s12 m6 l4">
                                <div id="profile-card" class="card">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <p><i class="mdi-action-perm-identity cyan-text text-darken-2"></i> ＱＱ：<a href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo WEB_QQ; ?>&site=qq&menu=yes" class="pypl-btn pypl-btn--white mpp-btn icon-panel__cta" target="_blank"><?php echo WEB_QQ; ?></a>（小萝莉客服/请温柔对待）</p>
                                        <p><i class="mdi-action-perm-phone-msg cyan-text text-darken-2"></i> 电话：<?php echo WEB_MOBILE; ?><span style="font-size:14px;">（紧急技术支持，只解决技术问题）</span></p>
                                        <p><i class="mdi-communication-email cyan-text text-darken-2"></i> 邮箱：<?php echo WEB_QQ; ?>@qq.com<span style="font-size:14px;">（问题反馈，如果有问题可提交至该邮箱）</span></p>
