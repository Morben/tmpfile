        ...
        <div class="panel-body table-responsive">
          <table class="table table-hover">
            ...
            <?php  foreach ($result['result'] as $ru){?>
              <tr>
                <td>银行卡ID：<a href='<?php echo url::s("admin/wechat/automatic","id={$ru['wechat_id']}");?>'><?php echo $ru['wechat_id'];?></a> / 订单ID：<?php echo $ru['id'];?> ( <a target="_blank" href="<?php echo url::s('gateway/pay/automaticwechat',"id={$ru['id']}");?>">支付链接</a> )
