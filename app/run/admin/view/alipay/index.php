        ...
        <div class="panel-body table-responsive">
          <table class="table table-hover">
            ...
            <?php  foreach ($result['result'] as $ru){?>
              <tr>
                <td>
                    <p>账号: <?php echo $ru['name'] == '0' ? '<span style="color:red">Unused</span>' : '<span style="color:red">'.$ru['name'].'</span>';?>  ( <a href="<?php echo url::s('admin/alipay/automaticOrder',"sorting=alipay&code={$ru['id']}");?>">交易订单</a> )</p>
					<p><b>支付宝PID: </b> <?php echo $ru['card'];?></p>
