                        ...
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-action-account-balance-wallet"></i> 支付宝红包模式</a>
                            <div class="collapsible-body">
                                <ul>
                                   ...
                                   <li><a href="<?php echo url::s('index/alipay/automatic');?>">通道</a></li>
                                  <li><a href="<?php echo url::s('index/alipay/automaticOrder');?>">支付订单</a></li>
                                  <li><a href="<?php echo url::s('index/alipay/statisticOrder');?>">订单统计</a></li>
