  ...
  <div class="container">
    ...
    <nav class="nav pull-right">
        <ul class="text-center menuul clearfix">
                ...
                <li class="nav-item">
                    <a class="nav-item-a" href="/demo">体验中心</a>
                </li>
                <!-- <li class="nav-item">
  ...
  <div class="swiper-wrapper">
    ...
    <div class="swiper-slide slide5">
      ...
      <div class="banwuright ani" swiper-animate-effect="bounceInRight" swiper-animate-duration="0.4s" swiper-animate-delay="0.3s">
        ...
        <p class="ani" swiper-animate-effect="fadeInUp" swiper-animate-duration="0.5s" swiper-animate-delay="0.5s">打破传统,自行设置支付宝微信收款,实时调用</p>
...
<main id="index-page" class="main">
            ...
            <div class="col-md-6 row producttit">
              ...
              <div class="col-xs-4 col-md-4 col-lg-4">
                  <a href="javascript:;" class="product-item product-item2 flap" data-ani="fadeInUp" data-delay="0.1s">
                      <i class="product-item-img"></i>
                      <h3 class="product-item-tit">支付宝支付</h3>
              ...
              <div class="col-xs-4 col-md-4 col-lg-4">
                  <a href="javascript:;" class="product-item product-item3 flap" data-ani="fadeInUp" data-delay="0.1s">
                      <i class="product-item-img"></i>
                      <h3 class="product-item-tit">微信支付</h3>
  ...
  <section class="box bg-grey">
    ...
    <div class="guangdiv">
      <h6 class="flap" data-ani="fadeInDown" data-delay="0.1s"><b><?php echo WEB_NAME; ?></b>，帮助您更快的使用支付</h6>
      <span class="flap" data-ani="fadeInDown" data-delay="0.3s">选择<?php echo WEB_NAME; ?>是您最放心的选择</span>
