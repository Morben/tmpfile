...
?>
    ...
    font-size: 14px;" type="submit" value="查询"></th>
                  ...
                  <div class="input-field col s6" style="font-weight:normal;">
                    ...
                    <label> [ <a href="<?php echo url::s('index/service/order',"sorting=gateway&code=all");?>">全部</a> / <a href="<?php echo url::s('index/service/order',"sorting=gateway&code=wechat");?>">支付宝红包</a> / <a href="<?php echo url::s('index/service/order',"sorting=gateway&code=alipay");?>">支付宝</a> ] <?php if ($_SESSION['SERVICE']['ORDER']['WHERE'] == ''){?>(<a href="#" onclick="service();">开始查询</a>)<?php }else{?>(<a href="<?php echo url::s('index/service/order',"sorting=service&code=closed");?>">取消</a>)<?php }?></label>
                  </div>
