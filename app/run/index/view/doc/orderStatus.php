...
?>
 ...
 <div class="divider"></div>
 <p><b style="font-size:14px;">服务版状态查询接口URL（服务版<?php echo SYSTEM_VERSION; ?>）：</b><span style="color:green;"><?php echo URL_ROOT; ?>/gateway/pay/serviceQuery.do</span> </p>
        		...
        		<div  id="input-select">
                  <div class="input-field col s12">
                    ...
                    <select onchange="ls(this);">
                      ...
                      <option value="<?php echo URL_ROOT; ?>/gateway/pay/automaticWechatQuery.do" selected>微信商户版：<?php echo URL_ROOT; ?>/gateway/pay/automaticWechatQuery.do</option>
                      <option value="<?php echo URL_ROOT; ?>/gateway/pay/automaticAlipayQuery.do">支付宝商户版：<?php echo URL_ROOT; ?>/gateway/pay/automaticAlipayQuery.do</option>
                      <option value="<?php echo URL_ROOT; ?>/gateway/pay/serviceQuery.do">服务版（<?php echo SYSTEM_VERSION; ?>）：<?php echo URL_ROOT; ?>/gateway/pay/serviceQuery.do</option>
                    </select>
                  </div>
                  </div>
