...
?>
 ...
 <div class="divider"></div>
 <p><b style="font-size:14px;">服务版订单接口URL（服务版<?php echo SYSTEM_VERSION; ?>）：</b><span style="color:green;"><?php echo URL_ROOT; ?>/gateway/pay/service.do</span> </p>
        		...
        		<div  id="input-select">
                  <div class="input-field col s12">
                    ...
                    <select onchange="ls(this);">
                      ...
                      <option value="<?php echo URL_ROOT; ?>/gateway/pay/service.do">服务版（<?php echo SYSTEM_VERSION; ?>）：<?php echo URL_ROOT; ?>/gateway/pay/service.do</option>
                    </select>
                  </div>
