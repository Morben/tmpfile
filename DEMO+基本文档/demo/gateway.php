...
$callback_url = 'http://demo2.qqfe.xin/';
//支付成功后自动跳转url
$success_url = 'http://demo2.qqfe.xin/';
//支付失败或者超时后跳转url
$error_url = 'http://demo2.qqfe.xin/';
...
<body>
<form action="http://demo2.qqfe.xin/gateway/index/checkpoint.do " method="post" id="frmSubmit">
